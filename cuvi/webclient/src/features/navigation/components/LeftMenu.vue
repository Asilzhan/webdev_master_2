...
onMounted(() => {
  console.log("LeftMenu is mounted");
});
</script>
...
.link {
  @apply p-4 block text-gray-700 hover:bg-gray-200 hover:text-gray-900 focus:outline-none focus:bg-gray-300 focus:text-gray-900 active:bg-gray-400;
}
</style>
